...
- [LIBRARY](/library/README.md)
  - [bigintString](/library/bigintString/README.md)
  - [boxed-list](/library/boxed-list/README.md)
  - [colors-tools](/library/colors-tools/README.md)
  - [human-size](/library/human-size/README.md)
  - [mapping-tools](/library/mapping-tools/README.md)
  - [object-with-expectations](/library/object-with-expectations/README.md)
  - [parallel-mapper](/library/parallel-mapper/README.md)
...
- [Typing Prompter](/prompts/typing_prompter/README.md): Instructions and scripts for typing prompts.
- [Chat GPT](/prompts/chatgpt/README.md): Scripts and resources related to ChatGPT prompts.
- [More Prompts](/prompts/more_prompts/README.md): Additional prompts for various applications.

### PRIVATE

- [Backend](/private/backend/README.md): Backend logic, including APIs and server-side scripts.
  - [API](/private/backend/api/README.md): API-specific documentation and scripts.
  - [Scratch](/private/backend/scratch/README.md): Temporary or experimental backend scripts.
- [Frontend](/private/frontend/README.md): Frontend components and user interface elements.
  - [Home](/private/frontend/home/README.md): Frontend resources for the home directory.
