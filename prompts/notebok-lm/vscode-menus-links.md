# Visual Studio Code Menus and Links

This document provides links to the Visual Studio Code documentation. The links are organized by category.
...
[Educators & Students](https://code.visualstudio.com/docs/getstarted/educators-and-students)
...
[Refactoring](<https://code.visualstudio.com/docs/editor/refactoring>" aria-label="Current Page: Refactoring
